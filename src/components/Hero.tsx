...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen relative overflow-hidden bg-gradient-to-br from-gray-900 via-blue-950 to-gray-900 dark:from-gray-950 dark:via-blue-950 dark:to-gray-950">
      ...
      {/* Scroll Indicator with Click Event */}
      <button
